		...
		public List<Localizations> Default()
		{
			List<Localizations> langs = new List<Localizations>() {
				...
				new Localizations("ja-JP") {
					["Cashier Name"] = "レジ係 {0}",
					["Restocker Name"] = "品出し係 {0}",
					["Customer Helper Name"] = "顧客ヘルパー {0}",
					["Lvl"] = "<size=70%>Lv </size>{0}",
					["Popup Exp"] = "{0} EXP",
					["TRAINING"] = "トレーニング",
					["Cashiers"] = "レジ係",
					["Restockers"] = "品出し係",
					["Customer Helpers"] = "<size=95%>顧客ヘルパー</size>",
					["Exp."] = "EXP",
					["Level"] = "レベル {0} 【{1}】",
					...
					["NO RESTOCKERS HIRED"] = "品出し係を雇っていません",
					["NO CUSTOMER HELPERS HIRED"] = "顧客ヘルパーを雇っていません",
				},
				...
				new Localizations("tr") { // トルコ
					...
					["NO RESTOCKERS HIRED"] = "DEPO GÖREVLI IŞE ALINMADI",
					["NO CUSTOMER HELPERS HIRED"] = "MÜSTERI YARDIMCILARI IŞE ALINMADI",
				},
