		...
		public List<Localizations> Default()
		{
			List<Localizations> langs = new List<Localizations>() {
				...
				new Localizations("da-DK") { // デンマーク
					...
					["Level"] = "Niveau {0} - {1}",
					["TRAINING"] = "UDDANNELSE",
					["Cashiers"] = "<size=80%>Kassemedarbejdere</size>",
					["Restockers"] = "<size=80%>Lagermedarbejdere</size>",
					["Customer Helpers"] = "<size=80%>Kundemedhjælpere</size>",
				...
				new Localizations("hu-HU") { // ハンガリー
					...
					["Upgrade warning"] = "Előlépteti {0}-t a(z) {1} szintre?\n\nHatékonyabb lesz de\na napi bére MEGNŐ {2}</size>-ra/re.",
				...
				new Localizations("ro-RO") { // ルーマニア
					...
					["Customer Helpers"] = "<size=80%>Ajutor\nClienți</size>",
